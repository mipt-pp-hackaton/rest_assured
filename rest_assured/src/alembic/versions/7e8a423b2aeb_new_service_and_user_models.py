...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_notification_log_incident_id'), 'notification_log', ['incident_id'], unique=False)
    op.create_index(op.f('ix_notification_log_service_id'), 'notification_log', ['service_id'], unique=False)
